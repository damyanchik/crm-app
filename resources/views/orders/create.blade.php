...
@section('content')
    <div class="container rounded bg-white mb-5">
        <div class="row">
            <form method="post" action="/orders/" class="col-md-6 border-right">
                @csrf
                <div class="p-3 py-2">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Tworzenie nowego zamówienia</h4>
                    </div>
                    <div class="row">
                        <div class="col-md-12 mt-2"><span class="labels">Klient</span>
            ...
            <div class="col-md-6">
                <div class="p-3 py-2">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Dodawanie produktów</h4>
                    </div>
                    <div class="row">
                        ...
                        <div class="mt-5 text-center"><button id="addProduct" class="btn btn-primary profile-button" type="button">Dodaj produkt</button></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        $("#addProduct").click(function () {
                ...
                const productDiv = `
                            <tr class="product">
                                ...
                                <td>${newPrice} PLN ${newUnit === '0' ? 'szt.' : 'kpl.'} / ${newTotalPrice} </td>
